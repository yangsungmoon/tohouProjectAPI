...
void effectManager::addEffect(string effectName, const char* imageName, int imageWidth, int imageHeight, int effectWidth, int effectHeight, float fps, float elapsedTime, int buffer)
{
	image* img;
	...
	{
		img = IMAGEMANAGER->addImage(imageName, imageName, imageWidth, imageHeight, false, true, RGB(255, 0, 255));
	}
